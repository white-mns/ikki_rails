class StatusesController < ApplicationController
  ...
  def index
    ...
    @count	= Status.notnil().includes(:pc_name, :guardian).ransack(params[:q]).result.hit_count()
    @search	= Status.notnil().includes(:pc_name, :guardian).page(params[:page]).ransack(params[:q])
